...
class Driver {
    ...
    constructor(settings) {
        ...
        if (settings.endpoint && settings.database) {
            (_a = settings.logger) === null || _a === void 0 ? void 0 : _a.warn('The "endpoint" and "database" fields are deprecated. Use "connectionString" instead');
        ...
        const sslCredentials = secure
            ? (_b = settings.sslCredentials) !== null && _b !== void 0 ? _b : (0, ssl_credentials_1.makeDefaultSslCredentials)()
            : undefined;
    ...
    async destroy() {
        ...
        await Promise.all([
            ...
            (_a = this._topicClient) === null || _a === void 0 ? void 0 : _a.destroy(),
        ]);
