...
async function initDriver(settings) {
    ...
    const driver = new driver_1.default(Object.assign({ endpoint: process.env.YDB_ENDPOINT || `grpc://localhost:2136`, database: DATABASE, authService: new anonymous_auth_service_1.AnonymousAuthService(), sslCredentials }, settings));
