...
class TableSession extends events_1.default {
    ...
    async executeQuery(query, params = {}, txControl = exports.AUTO_TX, settings) {
        ...
        const response = (settings === null || settings === void 0 ? void 0 : settings.idempotent)
            ? await executeQueryRetryer.retry(() => this.api.executeDataQuery(request))
            : await this.api.executeDataQuery(request);
        const payload = (0, process_ydb_operation_result_1.getOperationPayload)(this.processResponseMetadata(request, response, settings === null || settings === void 0 ? void 0 : settings.onResponseMetadata));
