...
class TableSessionPool extends events_1.default {
    constructor(settings) {
        ...
        this.minLimit = (poolSettings === null || poolSettings === void 0 ? void 0 : poolSettings.minLimit) || TableSessionPool.SESSION_MIN_LIMIT;
        this.maxLimit = (poolSettings === null || poolSettings === void 0 ? void 0 : poolSettings.maxLimit) || TableSessionPool.SESSION_MAX_LIMIT;
...
TableSessionPool.SESSION_MIN_LIMIT = 1; // TODO: Return back to 5
TableSessionPool.SESSION_MAX_LIMIT = 20;
__decorate([
